! function(e, t) {
    ...
    class i {
        ...
        load = ({
            ...
            signal: a
        } = {}) => (this.#e || (this.#e = s ? new Worker(new URL(s, "file:///home/jeromewu/ffmpeg.wasm/packages/ffmpeg/dist/esm/classes.js"), {
            type: "module"
        }) : new Worker(getWorkerURL(new URL(e.p + e.u(814), e.b)), {
            type: void 0
        }), this.#o()), this.#i({
            type: t.LOAD,
            data: r
